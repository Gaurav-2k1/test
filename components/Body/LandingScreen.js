...
export default function LandingScreen() {
  return (
    <div className="w-full bg-[url('/images/bg.jpg')] bg-cover bg-center h-[80vh]">
      <div className="flex flex-col h-1/2 justify-around">
        ...
        <p className="text-blue-900 text-center p-4 bg-blue-200 bg-opacity-50">
          25000 Courses | 15000 Elite Tutors | Thousands of Students Trained
          worldwide!
        </p>
      </div>
      <div className="w-full lg:w-1/2 m-auto h-16 bg-blue-100 shadow flex flex-row justify-between">
        <input
