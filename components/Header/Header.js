  ...
  return (
    <div className="w-full bg-slate-50 sticky top-0 left-0 right-0">
      ...
      <div className="flex flex-row justify-evenly">
        <div className="hidden lg:flex relative w-24 h-24 lg:w-30 lg:h-30 ">
          <Image
            className="lg:w-30"
            src="/logo.png"
            alt="Logo"
        ...
        <div className="hidden lg:flex lg:self-center ">
          ...
          <div className="text-base font-bold lg:self-center lg:ml-10">
        ...
        >
          <div className="text-center text-2xl h-full">
            ...
            <div className=" lg:flex flex-row gap-4  p-4">
              ...
              <div className="text-base font-bold  lg:mt-8 lg:ml-10">
                {" "}
                <EmailIcon className="text-3xl" />
                contact@infodal.com
              </div>
