    ...
    <div>
      ...
      <div className="flex flex-col justify-evenly m-auto lg:grid lg:grid-cols-2 lg:gap-4 p-4">
        ...
        <div className="flex flex-col justify-around lg:h-[40vh] lg:w-3/4 mb-5 lg:m-0 text-center lg:text-left">
          <h1 className="text-3xl font-semibold my-5 lg:m-0">What do we do?</h1>
          <p>
            Scared of adapting to the new changes or worried about how to learn
            and pace with the digitally advanced society? Keep your worries
            aside as Infodal provides you with certified, digital, and
            ...
            courses. We as one of the most renowned brands assure you to provide
            the best of the deals and courses on the virtual platform with all
            updated knowledge and applications at use.
          </p>
        </div>
      </div>
      <div className="flex flex-col justify-evenly m-auto lg:grid lg:grid-cols-2 lg:gap-4 p-4">
